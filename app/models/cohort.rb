class Cohort < ApplicationRecord
  ...
  has_many :mentors, -> { distinct }, through: :relationships, foreign_key: 'mentor_id', class_name: 'User'
  has_many :mentees, -> { distinct }, through: :relationships, foreign_key: 'mentee_id', class_name: 'User'
